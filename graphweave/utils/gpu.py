...
Usage
-----
>>> from graphweave.utils.gpu import gpu_cosine_similarity, is_gpu_available
...
def gpu_refine_embeddings(
    ...
    """GPU-accelerated version of GraphWeave._refine_embeddings.
